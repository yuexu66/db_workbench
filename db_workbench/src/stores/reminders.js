...
export const REMINDER_TYPES = [
  { key: 'birthday', label: '生日纪念', color: '#ff6b9d' },
  { key: 'subscription', label: '订阅续费', color: '#52c41a' },
  { key: 'insurance', label: '车辆保险', color: '#fa8c16' },
  { key: 'bill', label: '账单还款', color: '#4A90D9' },
  { key: 'gift', label: '人情往来', color: '#f5222d' },
  { key: 'id', label: '证件到期', color: '#722ed1' },
  { key: 'health', label: '健康医药', color: '#13c2c2' },

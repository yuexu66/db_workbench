(function(global, factory) {
  ...
  function useEventListener(type, listener, options = {}) {
    ...
    let stopWatch;
    if (vue.isRef(target)) stopWatch = vue.watch(target, (val, oldVal) => {
      remove2(oldVal);
      add(val);
    });
    return () => {
  ...
  function useWindowSize() {
    if (!useWindowSize_width) {
      useWindowSize_width = vue.ref(0);
      useWindowSize_height = vue.ref(0);
      if (inBrowser) {
        const update = () => {
  ...
  **/
    ...
    setup(props2, {
      ...
      const onScroll = () => {
        ...
        for (let i = 0; i < months.value.length; i++) {
          ...
          const visible = height <= bottom2 && height + heights[i] >= top;
          if (visible) {
            visibleRange[1] = i;
            if (!currentMonth) {
              currentMonth = month;
  ...
  var stdin_default$S = vue.defineComponent({
    ...
    setup(props2, {
      ...
      const gapX = vue.computed(() => isObject$1(props2.gap) ? props2.gap.x : props2.gap);
      const gapY = vue.computed(() => isObject$1(props2.gap) ? props2.gap.y : props2.gap);
  ...
  function getContainingBlock(element) {
    ...
    while (isHTMLElement(currentNode) && [
      ...
      if ("none" !== css.transform || "none" !== css.perspective || "paint" === css.contain || -1 !== [
        "transform",
        "perspective"
      ].indexOf(css.willChange) || isFirefox && "filter" === css.willChange || isFirefox && css.filter && "none" !== css.filter) return currentNode;
  ...
  function getOffsetParent(element) {
    ...
    if (offsetParent && ("html" === getNodeName(offsetParent) || "body" === getNodeName(offsetParent) && "static" === getComputedStyle(offsetParent).position)) return window1;
  ...
  function popperGenerator(generatorOptions) {
    ...
    var _generatorOptions = generatorOptions, _generatorOptions$def = _generatorOptions.defaultModifiers, defaultModifiers = void 0 === _generatorOptions$def ? [] : _generatorOptions$def, _generatorOptions$def2 = _generatorOptions.defaultOptions, defaultOptions2 = void 0 === _generatorOptions$def2 ? DEFAULT_OPTIONS : _generatorOptions$def2;
    return function(reference, popper, options) {
      if (void 0 === options) options = defaultOptions2;
      var state = {
        placement: "bottom",
        orderedModifiers: [],
      ...
      var instance2 = {
        ...
        setOptions: function(setOptionsAction) {
          var options2 = "function" == typeof setOptionsAction ? setOptionsAction(state.options) : setOptionsAction;
        ...
        forceUpdate: function() {
          ...
          if (!areValidElements(reference2, popper2)) return;
          state.rects = {
            reference: getCompositeRect(reference2, getOffsetParent(popper2), "fixed" === state.options.strategy),
          ...
          for (var index = 0; index < state.orderedModifiers.length; index++) {
            ...
            var _state$orderedModifie = state.orderedModifiers[index], fn = _state$orderedModifie.fn, _state$orderedModifie2 = _state$orderedModifie.options, _options = void 0 === _state$orderedModifie2 ? {} : _state$orderedModifie2, name2 = _state$orderedModifie.name;
      ...
      if (!areValidElements(reference, popper)) return instance2;
      instance2.setOptions(options).then(function(state2) {
        if (!isDestroyed && options.onFirstUpdate) options.onFirstUpdate(state2);
      });
      function runModifierEffects() {
        state.orderedModifiers.forEach(function(_ref) {
          var name2 = _ref.name, _ref$options = _ref.options, options2 = void 0 === _ref$options ? {} : _ref$options, effect = _ref.effect;
  ...
  function eventListeners_effect(_ref) {
    ...
    if (resize) window1.addEventListener("resize", instance2.update, passive);
    return function() {
      if (scroll) scrollParents.forEach(function(scrollParent) {
        scrollParent.removeEventListener("scroll", instance2.update, passive);
      });
      if (resize) window1.removeEventListener("resize", instance2.update, passive);
    };
  }
  ...
  function applyStyles(_ref) {
    ...
    Object.keys(state.elements).forEach(function(name2) {
      ...
      Object.keys(attributes).forEach(function(name3) {
        ...
        if (false === value) element.removeAttribute(name3);
        else element.setAttribute(name3, true === value ? "" : value);
      });
    });
  }
  ...
  function offset_offset(_ref2) {
    ...
    var _options$offset = options.offset, offset = void 0 === _options$offset ? [
      0,
      0
    ] : _options$offset;
    ...
    setup(props2, {
      ...
      const createPopperInstance = () => {
        if (wrapperRef.value && popoverRef.value) {
          return popper_lite_createPopper(wrapperRef.value, popoverRef.value.popupRef.value, getPopoverOptions());
        }
        return null;
      };
